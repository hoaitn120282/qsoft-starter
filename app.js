...
const apiController = require(process.cwd() + "/src/controllers/api");
const contactController = require(process.cwd() + "/src/controllers/contact");

/**
 * API keys and Passport configuration.
 */
const passportConfig = require(process.cwd() + "/config/passport");
/**
 * Loading model
 */
